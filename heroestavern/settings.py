"""
Django settings for heroestavern project.
...
WSGI_APPLICATION = 'heroestavern.wsgi.application'
...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'heroestavern.serializers.CurrentUserSerializer'
}